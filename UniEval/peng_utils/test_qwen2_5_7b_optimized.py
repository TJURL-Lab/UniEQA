...
class Testqwen2_5_7b_optimized:
    def __init__(self, device=None):
        print("🚀 Loading Qwen2.5-VL-7B-Instruct with optimizations...")
    ...
    def generate_image(self, image_list_list, question_list):
        """主要接口：自动选择批量或单个推理"""
        print("🚀 Qwen2.5-VL optimized inference begins")
        ...
        print("✅ Qwen2.5-VL optimized inference finished")
        return outputs 